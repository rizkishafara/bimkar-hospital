                    ...
                    <section>
                        ...
                        <form class="mt-6" action="{{ route('pasien.janji-periksa.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label
                                    for="formGroupExampleInput">Nomor Rekam Medis</label>
                                <input type="text"
                                    class="form-control rounded" id="formGroupExampleInput"
                                    placeholder="Example input"
                                    value="{{ $no_rm }}" readonly>
                            </div>
                            <div class="form-group">
                                <label
                                    for="dokterSelect">Dokter</label>
                                <select class="form-control"
                                    ...
                                    $dokter)
                                    @foreach
                                    ($dokter->jadwalPeriksas as $jadwal)
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control"
                                    name="keluhan" id="keluhan" rows="3" required></textarea>
                            </div>
                            <div class="flex items-center gap-4">
                                <button type="submit" class="btn btn-primary">Submit</button>
                                @if (session('status') ===
                                'janji-periksa-created')
                                <p x-data="{ show: true }"
                    ...
                    <table class="table table-hover rounded overflow-hidden mt-6">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-start">
                                    @if
                                    (is_null($janjiPeriksa->periksa))
                                    <span class="badge badge-pill badge-warning">Belum Diperiksa</span>
                                    @else
                                    <span class="badgebadge-pill badge-success">Sudah Diperiksa</span>
                                    @endif
                                </td>
                                <td class="align-middletext-start">
                                    @if
                                    (is_null($janjiPeriksa->periksa))
                                    <button
                                        type="submit" class="btn btn-info" data-toggle="modal"
                                    ...
                                    @else
                                    <button
                                        type="submit" class="btn btn-secondary" data-toggle="modal"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <h6
                                                        class="font-weight-bold mb-3">Daftar Obat Diresepkan:

                                                    </h6>
                                                    <ul
                                                        class="list-group mb-3">

                                                        @foreach ($janjiPeriksa->periksa->detailPeriksas as
                                                        $detailPeriksa)
