                ...
                <section>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="border-black col-md-6 border-end">
                                    <div class="mb-3">
                                        <label
                                            class="font-semibold text-gray-700 form-label">Tanggal
                                            Periksa</label>
                                        <div
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label
                                            class="font-semibold text-gray-700 form-label">Catatan</label>
                                        <div
                                            class="form-control-plaintext">
                    ...
                    <div class="mb-4 border-2 card">
                        ...
                        <div class="card-body">
                            ...
                            @else
                            <p class="mb-0 text-muted">Tidak
                                ada obat yang diresepkan.</p>
                            @endif
                        </div>
                    </div>
